...
void Logo() {
	...
	cout << "\n";
	cout << "==========================================================================================================\n";
	cout << "                     В стеке целых целых чисел поменять местами N первых и N последних элементов\n";
	cout << "==========================================================================================================\n";
	cout << "\n";
	cout << "==========================================================================================================\n";
...
void Stack::push(Element* Head, int Val) {
	insertElement(Head, Head, 1, Val);
}


int Stack::pop(Element* Head) {
	int Data; 
	Data = getElementData(Head, 1);
	deleteElement(Head, Head, 1);
	return(Data);
}
