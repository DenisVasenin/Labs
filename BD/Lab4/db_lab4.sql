...
--
-- Хост: localhost:3306
-- Время создания: Апр 18 2018 г., 17:27
...
INSERT INTO `artist` (`artist_id`, `name`, `surname`, `year`) VALUES
(1, 'Eric', 'Bana', 1965),
(2, 'Lou', 'Ferrigno', 1978),
(3, 'Jennifer', 'Connelly', 1982),
(4, 'Robert', 'Downey', 1988),
(5, 'Gwyneth', 'Paltrow', 1979),
(6, 'Leslie', 'Bibb', 1960),
(7, 'Jon', 'Favreau', 1965),
(8, 'Liv', 'Tyler', 1982),
(9, 'Jane', 'Lawrens', 1971),
...
(6, 'Runaway', 2011, 'Russia'),
(7, 'Warcraft', 2016, 'England');
...
--
ALTER TABLE `artist`
  MODIFY `artist_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT для таблицы `cast`
--
ALTER TABLE `cast`
  MODIFY `cast_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT для таблицы `film`
--
ALTER TABLE `film`
  MODIFY `film_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
